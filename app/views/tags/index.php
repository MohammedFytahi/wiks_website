                            ...
                            <li class="mr-3 flex-1">
                                <a href="<?php echo URLROOT; ?>/tags/index2"
                                    ...
                                    <i class="fas fa-chart-area pr-0 md:pr-3 text-blue-600"></i><span
                                        class="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block">Manage
                                        Tags</span>
                                </a>
                            </li>
                            <li class="mr-3 flex-1">
            ...
            <section class="container lg:ml-80 my-8 max-w-md:mx-auto ">
                ...
                <div class="row mb-3">
                    ...
                    <?php foreach ($data['tags'] as $tag): ?>
                        <div class="w-full max-w-sm bg-indigo-200 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="flex flex-col items-center pb-10">
                                ...
                                <div class="flex flex-col mt-4 md:mt-6">
                                    <form class="flex items-center"
                                        ...
                                        <p id="tag_name_err_<?php echo $tag->tagId; ?>"
                                            class="text-red-500 text-xs italic">
                                            <?php echo isset($data['tag_name_err'][$tag->tagId]) ? $data['tag_name_err'][$tag->tagId] : ''; ?>
                                        </p>
